...
const ColletCourseDeleteRequestParams = z.object({
  studentId: z.string(),
  courseId: z.string(),
});
...
export async function GET(request: NextRequest) {
  ...
  const parsed = ColletCourseDeleteRequestParams.safeParse(
  ...
  try {
    const result = await searchCollectCourse.deleteCollectCourse(
